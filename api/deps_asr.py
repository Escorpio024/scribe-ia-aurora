...
# =========================
ASR_MODEL_NAME     = os.getenv("ASR_MODEL", "base")          # "base" o "small"/"medium"/"large-v3" si tienes GPU
ASR_LANGUAGE       = os.getenv("ASR_LANGUAGE", "es") or None
ASR_COMPUTE_TYPE   = os.getenv("ASR_COMPUTE_TYPE", "int8")   # "int8" CPU; "float16" en GPU
...
ASR_VAD_FILTER     = os.getenv("ASR_VAD_FILTER", "true").lower() == "true"
